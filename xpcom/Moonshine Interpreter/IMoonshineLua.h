...
class NS_NO_VTABLE IMoonshineLua : public nsISupports {
 public: 
  ...
  /* float Version (); */
  NS_IMETHOD Version(float *_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_IMOONSHINELUA \
  NS_IMETHOD Version(float *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_IMOONSHINELUA(_to) \
  NS_IMETHOD Version(float *_retval) { return _to Version(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_IMOONSHINELUA(_to) \
  NS_IMETHOD Version(float *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Version(_retval); } 
...
/* float Version (); */
NS_IMETHODIMP _MYCLASS_::Version(float *_retval)
{
